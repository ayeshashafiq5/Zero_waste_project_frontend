...
export default function RestaurantProfile() {
  ...
  const submit = async (e) => {
    ...
    setSaving(true);
    try {
      await authService.updateProfile({ ...form, lat, lng });
  ...
  return (
    <AppShell>
      ...
      <p className="text-sm text-gray-500 mt-1">Keep this up to date — NGOs see your details on every listing.</p>

      <div className="card p-6 mt-6 flex items-center gap-4">
        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-orange-400 to-red-500 text-white text-2xl font-bold flex items-center justify-center">
